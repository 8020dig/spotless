						...
						<li id="display-post-<?php the_ID(); ?>" <?php post_class('display-item display-item' . $i); ?>>
							...
							<article>
								...
								<a href="<?php the_permalink(); ?>" rel="bookmark">
									<div class="display-back-img lazy" data-original="<?php echo esc_url( $image[0] ); ?>" <?php echo $back_img; ?>></div>
								</a>
								...
								<div class="display-content">
									...
									<div class="entry-summary">
										<?php echo quadro_excerpt(get_the_excerpt(), 25, '<span class="read-more">' . esc_html__('Read more', 'indigo') . '</span>'); ?>
									</div><!-- .entry-summary -->
