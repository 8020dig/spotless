...
$videoposts_color 		= esc_attr( get_post_meta( $mod_id, 'quadro_mod_videoposts_color', true ) );
...
<section id="post-<?php the_ID(); ?>" class="quadro-mod type-videoposts clear <?php quadro_mod_parallax($mod_id); ?> modheader-<?php echo $header_layout; ?> overlay-<?php echo $overlay; ?>">
	...
	<div class="mod-content">
		...
		<div class="inner-mod">
			...
			<div class="videos-wrapper" style="color: <?php echo $videoposts_color; ?>;">
							...
							<li class="quadro-video">
								...
								<div class="video-post">
									<h3 class="entry-title">
										<a href="<?php the_permalink(); ?>" title="<?php get_the_title(); ?>" style="color: <?php echo $videoposts_color; ?>;">
											<?php the_title(); ?>
										</a>
									</h3>
									<p><?php quadro_excerpt(get_the_excerpt(), 25, '<span class="read-more">' . esc_html__('Read more', 'indigo') . '</span>'); ?></p>
								</div>
							</li>
