...
<section id="post-<?php the_ID(); ?>" class="quadro-mod caption-<?php echo $caption_pos; ?> type-pslider clear <?php quadro_mod_parallax($mod_id); ?> <?php echo $mod_margins; ?> modheader-<?php echo $header_layout; ?> overlay-<?php echo $overlay; ?>">
			...
			<div id="quadro-slider" class="quadro-slider-el">
				...
				<ul class="quadro-pslides slides">
					...
					<?php if( $quadro_slides->have_posts() ) : while( $quadro_slides->have_posts() ) : $quadro_slides->the_post(); ?>
						...
						$back_img = 'style="background-image: url(\'' . esc_url($thumb[0]) . '\');"'; 
						?>

						<li <?php post_class('quadro-pslide lazy'); ?> data-original="<?php echo esc_url($thumb[0]); ?>" <?php echo $back_img; ?>>
							...
							<div class="slide-caption">
								...
								<div class="entry-summary">
									<?php quadro_excerpt(get_the_excerpt(), 20, '<span class="read-more">' . esc_html__('Read more', 'indigo') . '</span>'); ?>
								</div>
