...
<header class="entry-header clear post-<?php echo $header_size; ?>-header post-title-<?php echo $header_text_color; ?> overlay-<?php echo $header_overlay; ?> header-<?php echo $header_back; ?> <?php echo $has_thumb; ?>" <?php echo $style; ?> data-original="<?php echo esc_url($image[0]); ?>">
