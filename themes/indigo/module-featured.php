						...
						<div class="entry-summary">
							...
							switch ( $post_format ) {
								...
								case 'audio':
									...
									echo $media_return['media'];
									echo quadro_excerpt($media_return['content'], 40, '<span class="read-more">' . esc_html__('Read more', 'indigo') . '</span>');	
									break;

								case 'quote':
									echo quadro_just_quote(get_the_content(), '', '');
									echo '<a href="' . esc_url( get_the_permalink() ) . '" class="readmore-link"><span class="read-more">' . esc_html__('Read more', 'indigo') . '</span></a>';
									break;
								...
								default:
									quadro_excerpt(get_the_excerpt(), 40, '<span class="read-more">' . esc_html__('Read more', 'indigo') . '</span>');
									break;
