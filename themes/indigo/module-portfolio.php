				...
				<div class="terms-filter">
					<?php if ( $filter_terms != '' ) {
						...
						if ( count($filter_terms) > 1 ) {
							...
							echo '<li data-id="all" class="filter-active">' . esc_html__('All', 'indigo') . '</li>';
						...
						$filter_terms = get_terms( array( 'taxonomy' => 'portfolio_tax', 'hide_empty' => true ) );
