...
jQuery(document).ready(function() {
	...
	jQuery.fn.fireMmenu = function() {
		if ( ( $window.width() < 9600 || (jQuery('body').hasClass('header-layout8')||jQuery('body').hasClass('header-layout9')||jQuery('body').hasClass('header-layout12')||jQuery('body').hasClass('header-layout16')||jQuery('body').hasClass('header-layout17')) ) && isMobileMenu == false ) {
			// Clone current menu
			...
			var socialMenu = jQuery('#menu-footer-social').clone();
			socialMenu.addClass('m-social-menu');
			var burgerMenu = jQuery('.menu-hamburger-container').clone();
