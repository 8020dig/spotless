...
<section id="post-<?php the_ID(); ?>" class="quadro-mod type-sl-insights <?php quadro_mod_parallax($mod_id); ?> modheader-<?php echo $header_layout; ?> nav-<?php echo $nav; ?> overlay-<?php echo $overlay; ?>">

	<?php // Apply function for inline styles
	quadro_mod_styles( $mod_id ); ?>

	<style scoped>#post-<?php echo the_ID(); ?> .flex-control-nav a { color: <?php echo $color; ?>; }</style>
						...
						<li class="sl-insight <?php echo esc_attr( $sl_insight['layout'] ); ?>-sl-insight">
							...
							if (  $sl_insight['title'] != '' || $sl_insight['content'] != '' ) { ?>
								<div class="sl-insight-text <?php echo $qi_animations[$anim]['second']; ?>" data-wow-delay="<?php echo $anim_delay; ?>ms" style="color: <?php echo $color; ?>;">
									...
									<a href="<?php echo esc_url($sl_insight['button_url']); ?>" title="<?php echo esc_attr($sl_insight['button_text']); ?>" class="qbtn sl-insight-link scroll-to-link" style="color: <?php echo $color; ?>;"><?php echo esc_attr($sl_insight['button_text']); ?></a>
									<?php } ?>
								</div>
							<?php } ?>
