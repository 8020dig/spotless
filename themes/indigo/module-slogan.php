...
<section id="post-<?php the_ID(); ?>" class="quadro-mod type-slogan <?php quadro_mod_parallax($mod_id); ?> modheader-<?php echo $header_layout; ?> size-<?php echo $size; ?> align-<?php echo $align; ?> overlay-<?php echo $overlay; ?>" <?php echo $style; ?>>
	...
	if ( $video_mp4 != '' || $video_webm != '' || $video_ogv != '' ) {
		$video_html = '<div class="video-wrap">
			<img class="mobile-video-poster" src="' . $video_poster . '" style="display:none;" alt="Video Poster">
			<video class="slogan-video-back" preload="auto" loop autoplay muted>';
				...
				$video_html .= '<object width="320" height="240" type="application/x-shockwave-flash" data="flashmediaelement.swf">
        			<param name="movie" value="flashmediaelement.swf" /> 
        			<param name="flashvars" value="controls=false&amp;poster='.$video_poster.'&amp;file='.$video_mp4.'" />        
        			<img src="'.$video_poster.'" alt="Video Poster"/>
    			</object>';
			$video_html .='</video>
		</div>';
	...
	<div class="mod-content">
		...
		<div class="inner-mod">
			...
			<div class="slogan-wrapper">
				...
				<?php if ( $action_text != '' ) { ?>
					<a href="<?php echo $action_link; ?>" style="color: <?php echo $action_color; ?> !important; background: <?php echo $action_back; ?>;" class="slogan-call-to-action qbtn scroll-to-link <?php echo $qi_animations[$anim]['second']; ?>" data-wow-delay="<?php echo $anim_delay; ?>ms"><?php echo $action_text; ?></a>
				<?php } ?>

				<?php if ( $action2_text != '' ) { ?>
					<a href="<?php echo $action2_link; ?>" style="color: <?php echo $action2_color; ?> !important; background: <?php echo $action2_back; ?>;" class="slogan-call-to-action qbtn scroll-to-link <?php echo $qi_animations[$anim]['second']; ?>" data-wow-delay="<?php echo $anim_delay; ?>ms"><?php echo $action2_text; ?></a>
				<?php } ?>
