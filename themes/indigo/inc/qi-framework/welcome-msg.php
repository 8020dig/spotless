				...
				<div class="qi-welcome-content clear">
					...
					<ul class="welcome-tips">
						<li>
							...
							<p>' . wp_kses_post( __('The documentation file for this theme has lots of helpful sections, including a nice <strong>Getting Started</strong> with step by step descriptions on how to start working with it.', 'quadro') ) . ' <a href="' . $qi_docs_url . '" target="_blank">' . esc_html__('You can find it here.', 'quadro') . '</a></p>
						</li>
						<li>
						...
						<li>
							...
							<p>' . esc_html__('Should you need help with the theme and you can\'t find the answer on the documentation file, we\'ll be ready to cover you on our', 'quadro') . ' <a href="' . $qi_support_url . '" target="_blank">' . esc_html__('Support Forum.', 'quadro') . '</a></p>
						</li>
						<li>
