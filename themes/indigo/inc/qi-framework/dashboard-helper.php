...
function quadro_toolbar( $wp_admin_bar ) {
	...
	$args = array(
		...
		'title' => esc_html__('Knowledge Base', 'quadro'),
		'parent' => 'quadro_toolbar',
		'href'  => '//artisanthemes.io/knowledgebase/?theme=' . $theme_slug,
	...
	$args = array(
		...
		'parent' => 'quadro_toolbar',
		'href'  => '//artisanthemes.io/support-center/',
