...
/*******
  ...
  Modified by Artisan Themes https://artisanthemes.io
*******/
...
$api_url = 'https://artisanthemes.io/at-updates';
...
function qi_theme_update_check($checked_data) {
	...
	// set arguments even if not present
	if ( !isset( $quadro_options['quadro_username'] ) ) {
		$quadro_options['quadro_username'] = false;
		$quadro_options['quadro_userpass'] = false;
		$quadro_options['quadro_userlicense'] = false;
	}
...
// Add these functions only if updates enabled in Theme Options (or if this is a free one)
if ( !isset( $quadro_options['updates_enable'] ) || isset($quadro_options['updates_enable']) && $quadro_options['updates_enable'] == true ) {
