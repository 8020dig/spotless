...
class quadro_recent_posts extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'classname' => 'quadro-recents-widget', 'description' => esc_html__('Quadro Recent Posts with thumbnails.', 'indigo') )
		);
	}
	...
	public function widget( $args, $controls ) {
		...
		if ( $title ) echo $before_title . esc_attr( $title, 'indigo' ) . $after_title; ?>
	...
	public function form( $controls ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e('Title:', 'indigo'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'post_count' ) ); ?>"><?php esc_html_e('Post Quantity:', 'indigo'); ?></label>
...
class quadro_featured_post extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'classname' => 'quadro-featured-widget', 'description' => esc_html__('Quadro Featured Post.', 'indigo') )
		);
	}
	...
	public function form( $controls ) {
		...
		<!-- Post Quantity: Text Input -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'feat_post' ) ); ?>"><?php esc_html_e('Select Post:', 'indigo'); ?></label>
...
class quadro_image_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'classname' => 'quadro-image-widget', 'description' => esc_html__('Quadro Image Widget.', 'indigo') )
		);
	}
	...
	public function widget( $args, $controls ) {
		...
		if ( $controls['image_url'] != '' ) {
			...
			if ( $title )
				echo $before_title . esc_attr( $title, 'indigo' ) . $after_title; ?>
	...
	public function form( $controls ) {
		...
		<p>
			...
			<input class="upload_file_button" type="button" value="<?php esc_html_e('Upload Image', 'indigo'); ?>" />
			</label>
		</p>
...
class quadro_video_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'classname' => 'quadro-video-widget', 'description' => esc_html__('Quadro Video Widget.', 'indigo') )
		);
	}
	...
	public function form( $controls ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'video_url' ) ); ?>"><?php esc_html_e('Video Embed Url:', 'indigo'); ?></label>
...
class quadro_ads_widget_1col extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'classname' => 'quadro-ads-widget-1col', 'description' => esc_html__('Add your advertising shortcodes or banner images.', 'indigo') )
		);
	}
	...
	public function widget( $args, $controls ) {
		...
		for ( $i = 1; $i <= $ad_spots; $i++ ) {
			if ( $controls['ad_shortcode_'.$i] ) {
				...
				echo do_shortcode( wp_kses_post( $controls['ad_shortcode_'.$i] ) );
				echo '</div>';
			}
	...
	public function form( $controls ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_spots' ) ); ?>"><?php esc_html_e('Ad Spots:', 'indigo'); ?></label>
			...
			<br /><small><?php esc_html_e('Enter the number of desired ad spots, and click "Save" to refresh widget controls.', 'indigo'); ?></small>
		</p>
		<!-- Widget Title: Text Input -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e('Title:', 'indigo'); ?></label>
		...
		<?php for ( $i = 1; $i <= $controls['ad_spots']; $i++ ) { ?>
			...
			<!-- Image Ad Upload -->
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'ad_img_'.$i ) ); ?>"><?php esc_html_e('Image Ad Upload:', 'indigo'); ?></label>
			...
			<!-- Ad URL: Text Input -->
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'ad_url_'.$i ) ); ?>"><?php esc_html_e('Image Ad Link:', 'indigo'); ?></label>
				...
				<small><?php esc_html_e('Insert URL destination for your ad', 'indigo'); ?></small>
			</p>
			<!-- Ad Target: Text Input -->
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'ad_target_'.$i ) ); ?>"><?php esc_html_e('Image Ad Link Target:', 'indigo'); ?></label>
				...
				<small><?php esc_html_e('Enter _self or _blank', 'indigo'); ?></small>
			</p>
			<!-- Ad Shortcode: Text Input -->
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'ad_shortcode_'.$i ) ); ?>"><?php esc_html_e('Ad Shortcode:', 'indigo'); ?></label>
				...
				<small><?php esc_html_e('Paste here shortcode from your Ads Plugin (overrides image upload)', 'indigo'); ?></small>
			</p>
		<?php } ?>
	<?php
	}
...
class quadro_ads_widget_2cols extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'classname' => 'quadro-ads-widget-2cols clear', 'description' => esc_html__('Add your advertising shortcodes or banner images.', 'indigo') )	
		);
	}
