...
function quadro_get_option_parameters() {
	...
	$options = array(
		...
		'favicon_img' => array(
			'name' => 'favicon_img',
			'title' => esc_html__( 'Favicon Image File (For Pre WP 4.3 Versions)', 'quadro' ),
			'type' => 'upload',
			'description' => '',
			'section' => 'branding',
			'tab' => 'general',
		...
		'transients_enable' => array(
			...
			'title' => esc_html__( 'Transients Cache Enable On Modules', 'quadro' ),
			'type' => 'select',
			'valid_options' => array(
				'disabled' => array(
					'name' => 'disabled',
		...
		'scripts_deferring' => array(
			'name' => 'scripts_deferring',
			'title' => esc_html__( 'Scripts Deferring Enable', 'quadro' ),
			'type' => 'select',
			'valid_options' => array(
				'enabled' => array(
					'name' => 'enabled',
			...
			'description' => esc_html__('Enables the deferring of external scipts till after the page has load. Notice that some plugins may not work when Javascript deferring is enabled. If you have doubts about it, try it on/off our check with the plugin author.', 'quadro'),
			'section' => 'misc',
			'tab' => 'general',
			'default' => 'enabled'
		),
		...
		'quadro_username' => array(
			...
			'title' => esc_html__( 'Artisan Themes Username', 'quadro' ),
			'type' => 'text',
			'sanitize' => 'nohtml',
			'description' => wp_kses_post( __( 'Don\'t have an Artisan Themes user? Get yours <a href="https://artisanthemes.io" target="_blank">here</a>. <strong>Note: If you already have a username, you may need to login and register your theme before being able to update.</strong>', 'quadro' ) ),
			'section' => 'updates',
			'tab' => 'general',
			'customizer' => 'exclude',
			'default' => ''
		...
		'quadro_userpass' => array(
			...
			'title' => esc_html__( 'Artisan Themes Password', 'quadro' ),
			'type' => 'pass',
			'sanitize' => 'nohtml',
			'description' => '',
			'section' => 'updates',
		...
		'site_layout' => array(
			...
			'valid_options' => array(
				...
				'boxed' => array(
					...
					'description' => 'Uses the site background color as borders (Theme Options >> Design tab >> Background).',
				),
				'centered' => array(
					'name' => 'centered',
					'title' => 'Centered Site',
					'img' => 'site-layout3.png',
					'description' => 'Uses the site background on the sides (Theme Options >> Design tab >> Background).',
				),
			),
			'description' => '',
			'section' => 'site',
		...
		'header_layout' => array(
			...
			'valid_options' => array(
				...
				'layout7' => array(
					...
					'description' => esc_html__('Side Header. (Only with Streched Site & Background Header).', 'quadro'),
				),
				'layout8' => array(
					'name' => 'header-layout8',
					'title' => 'Layout 8',
		...
		'menu_header_display' => array(
			'name' => 'menu_header_display',
			'title' => esc_html__( 'Menu (show/hide)', 'quadro' ),
			'type' => 'select',
			'valid_options' => array(
				'show' => array(
					'name' => 'show',
		...
		'copyright_text' => array(
			...
			'section' => 'footer',
			'tab' => 'layout',
			'default' => 'Proudly powered by <a href="http://wordpress.org/" title="A Semantic Personal Publishing Platform">WordPress</a><span class="sep"> | </span>Indigo Theme by <a href="https://artisanthemes.io/">Artisan Themes</a>'
		),
		...
		'icon_font' => array(
			'name' => 'icon_font',
			'title' => esc_html__( 'Icon Font Selection', 'quadro' ),
			'type' => 'select',
			'valid_options' => array(
				'e-icons' => array(
					'name' => 'e-icons',
					'title' => esc_html__( 'Elegant Icons', 'quadro' )
				),
				'font-awesome' => array(
					'name' => 'font-awesome',
					'title' => esc_html__( 'Font Awesome', 'quadro' )
				),
			),
			'description' => '',
			'section' => 'icons',
		...
		'font_selection' => array(
			...
			'valid_options' => array(
				...
				'typekit_fonts' => array(
					'name' => 'typekit_fonts',
					'title' => esc_html__( 'Typekit Custom Kit', 'quadro' )
				),
				'custom' => array(
					'name' => 'custom',
		...
		'portf_transients_enable' => array(
			'name' => 'portf_transients_enable',
			'title' => esc_html__( 'Enable Portfolio Transients Cache', 'quadro' ),
			'type' => 'select',
			'valid_options' => array(
				'enabled' => array(
					'name' => 'enabled',
			...
			'description' => esc_html__('We recommend enabling this option for maximum performance improvements. Disable this option if you are using Page Builder elements or other plugins on the items which output dynamic CSS or Javascript code.', 'quadro'),
			'section' => 'portfolio',
			'tab' => 'portfolio',
			'default' => 'enabled'
		),
...
function quadro_get_settings_page_tabs() {
	$tabs = array( 
		'general' => array(
			'name' => 'general',
			'title' => '<span class="to-tab-icon"><i class="fa fa-sliders"></i></span>' . esc_html__( 'General', 'quadro' ),
			'sections' => array(
				'branding' => array(
					'name' => 'branding',
		...
		'layout' => array(
			'name' => 'layout',
			'title' => '<span class="to-tab-icon"><i class="fa fa-desktop"></i></span>' . esc_html__( 'Layout', 'quadro' ),
			'sections' => array(
				'site' => array(
					'name' => 'site',
				...
				'header' => array(
					...
					'description' => esc_html__( 'Manage Header options for Indigo Theme.', 'quadro' )
				),
				'blog' => array(
					'name' => 'blog',
					'title' => esc_html__( 'Blog & Archives Options', 'quadro' ),
					'description' => wp_kses_post( __( 'Manage Blog and Archives options for Indigo Theme.<br /><small>(Options selected in Blog modules over your site will override these)</small>', 'quadro' ) )
				),
				'single' => array(
					'name' => 'single',
				...
				'footer' => array(
					...
					'description' => esc_html__( 'Manage Footer options for Indigo Theme.', 'quadro' )
				),
				'sidebars' => array(
					'name' => 'sidebars',
		...
		'design' => array(
			'name' => 'design',
			'title' => '<span class="to-tab-icon"><i class="fa fa-eyedropper"></i></span>' . esc_html__( 'Design', 'quadro' ),
			'sections' => array(
				'colors' => array(
					'name' => 'colors',
		...
		'typography' => array(
			'name' => 'typography',
			'title' => '<span class="to-tab-icon"><i class="fa fa-font"></i></span>' . esc_html__( 'Typography', 'quadro' ),
			'sections' => array(
				'fonts' => array(
					'name' => 'fonts',
		...
		'social' => array(
			'name' => 'social',
			'title' => '<span class="to-tab-icon"><i class="fa fa-share-alt"></i></span>' . esc_html__( 'Social', 'quadro' ),
			'sections' => array(
				'profiles' => array(
					'name' => 'profiles',
		...
		'advertising' => array(
			'name' => 'advertising',
			'title' => '<span class="to-tab-icon"><i class="fa fa-usd"></i></span>' . esc_html__( 'Advertising', 'quadro' ),
			'sections' => array(
				'ads_header' => array(
					'name' => 'ads_header',
		...
		'portfolio' => array(
			'name' => 'portfolio',
			'title' => '<span class="to-tab-icon"><i class="fa fa-th"></i></span>' . esc_html__( 'Portfolio', 'quadro' ),
			'sections' => array(
				'portfolio' => array(
					'name' => 'portfolio',
		...
		'woocommerce' => array(
			'name' => 'woocommerce',
			'title' => '<span class="to-tab-icon"><i class="fa fa-shopping-cart"></i></span>' . esc_html__( 'WooCommerce', 'quadro' ),
			'sections' => array(
				'woocommerce' => array(
					'name' => 'woocommerce',
					'title' => esc_html__( 'WooCommerce Options', 'quadro' ),
					'description' => esc_html__('Settings for WooCommerce Plugin used with Indigo theme.', 'quadro')
				),
			)
		),
	);
